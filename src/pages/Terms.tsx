    ...
    <div>
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <p className="mb-4">We do not use any database to save user data, we use local storage as temporary memory. Users are responsible for inputting accurate data. The calculator's results depend on the accuracy of input data.</p>
